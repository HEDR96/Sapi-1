...
import { CattleHealthRecordWithMedia, HealthStatus } from '@samadya/shared/types'
import { formatDate } from '@samadya/shared/lib/utils/formatters'
import { HEALTH_STATUS_LABELS } from '@samadya/shared/types'
  ...
  if (!records || records.length === 0) {
    return (
      <div className="text-center py-8 text-[hsl(var(--forest))/50]">
        <img src="/images/21433058761642998739.svg" alt="Kesehatan" className="w-14 h-14 mx-auto mb-2 opacity-50" />
