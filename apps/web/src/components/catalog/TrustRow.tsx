...
const trustItems = [
  { icon: CircleCheck, title: 'Sesuai Syariat', description: 'Proses tertib dan amanah.' },
  { icon: FolderLock, title: 'Transparan', description: 'Bobot, kesehatan & pakan jelas.' },
  { icon: Users, title: 'Peternak Ahli', description: 'Ditangani tim berpengalaman.' },
  { icon: Home, title: 'Kandang Sehat', description: 'Bersih, nyaman, dan terawat.' },
  { icon: BadgeCheck, title: 'Layanan Amanah', description: 'Update cepat dan bertanggung jawab.' },
]
...
export function TrustRow() {
  ...
  return (
    <section ref={sectionRef} className="reveal mx-auto max-w-[1400px] px-4 pb-3 sm:px-5 lg:px-8">
      <div className="rounded-xl border border-[hsl(var(--line))] bg-[#FCFAF4] px-3 py-3 sm:px-4">
        <div className="grid gap-3 lg:grid-cols-[220px_1fr] lg:items-center">
          <div className="border-b border-[hsl(var(--line))] pb-3 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-4">
            ...
            <h3 className="mt-1.5 text-[22px] font-bold leading-[1.02] text-[hsl(var(--forest))] sm:text-[24px]">Transparansi & Kepercayaan</h3>
            <p className="mt-1 text-[8px] leading-4 text-[hsl(var(--forest))/55]">Data sapi jelas, perawatan tercatat, dan mudah dipantau.</p>
          </div>
