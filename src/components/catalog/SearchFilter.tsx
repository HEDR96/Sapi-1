    ...
    <div className="bg-white rounded-lg border border-[hsl(var(--line))] p-4 md:p-6">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className={cn(
            'flex items-center gap-2 rounded-md border border-[hsl(var(--line))] bg-white px-4 py-2.5 text-[11px] font-medium text-[hsl(var(--forest))] transition-colors hover:bg-[hsl(var(--cream))]',
            showFilters && 'bg-[hsl(var(--cream))]'
          )}
        >
          <Filter className="h-4 w-4" />
          Filter
          {hasActiveFilters && (
            <span className="ml-1 h-5 w-5 rounded-full bg-[hsl(var(--forest))] text-white text-[10px] flex items-center justify-center font-bold">
              !
            </span>
          )}
        </button>
      ...
      <div
        className={cn(
          'grid gap-4 mt-4 md:grid-cols-3 lg:grid-cols-6 transition-all',
      ...
      >
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            onChange={(e) => handleSearch({ ...filters, status: e.target.value })}
        ...
        <div className="space-y-1.5">
          ...
          <select
            value={filters.breed}
            onChange={(e) => handleSearch({ ...filters, breed: e.target.value })}
            className="w-full rounded-md border border-[hsl(var(--line))] bg-white px-3 py-2 text-[11px] text-[hsl(var(--forest))] focus:border-[hsl(var(--forest))] focus:outline-none"
          >
