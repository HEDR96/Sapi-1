...
export function HeroSection() {
  ...
  return (
    <section
      ref={heroRef}
      className="reveal mx-auto grid max-w-[1400px] grid-cols-1 items-stretch lg:grid-cols-[1.05fr_1.2fr_.45fr]"
    >
      {/* Hero Photo */}
      <div
      ...
      <div className="flex flex-col justify-center bg-[#F4EFE2] px-4 py-5 sm:px-7 sm:py-8 lg:px-8">
        ...
        <p className="mt-3 max-w-[520px] text-[11px] leading-5 text-[hsl(var(--forest))/75] sm:text-[13px]">
          Setiap sapi pilihan dirawat dengan penuh perhatian di peternakan kami. Anda bisa memantau bobot,
          kesehatan, dan perawatannya secara berkala sebelum memutuskan membeli.
        </p>
        ...
        <div className="mt-4 flex flex-wrap gap-2.5">
          <Link
            href="#katalog"
            className="rounded-md bg-[hsl(var(--forest))] px-4 py-2.5 text-[11px] font-semibold text-white shadow-card"
          >
            Pilih Sapi
          </Link>
          <Link
            href="#cara-kerja"
            className="rounded-md border border-[hsl(var(--forest))/25] bg-white px-4 py-2.5 text-[11px] font-semibold text-[hsl(var(--forest))]"
          >
            Lihat Cara Kerja
          </Link>
        </div>
      ...
      <div className="relative flex items-center justify-center overflow-hidden bg-[#F4EFE2] px-4 py-5 lg:px-6">
        ...
        <div className="nusa-tag tag-shape animate-float-tag relative w-[156px] rounded-[22px] px-4 pb-4 pt-10 sm:w-[198px] lg:w-[156px] xl:w-[198px] rotate-[7deg]">
          ...
          <div className="plate mt-2 rounded-[8px] px-2 py-2 text-center text-[18px] font-extrabold leading-none sm:text-[24px]">
            NF-26001
          </div>
          ...
          <div className="qr-box mx-auto mt-3 aspect-square h-[92px] w-[92px] shrink-0 rounded-[3px] bg-white p-1.5 sm:h-[116px] sm:w-[116px]">
            ...
            <div className="flex items-center justify-center h-full text-[6px] text-[hsl(var(--forest))/50] text-center">
              QR Code
            </div>
          </div>
